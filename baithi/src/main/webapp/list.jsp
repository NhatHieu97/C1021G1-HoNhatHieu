...
<h1 style="text-align: center">LIST ALL PRODUCT</h1>
<div class="container">
    ...
    <table id="product" border="1" class="table table-success">
        <thead>
        <tr>
        ...
        <c:forEach var="product" items="${productList}">
            <tr>
                ...
                <td>
                    <a href="/product?action=update&id=${product.getIdProduct()}"> <button class="btn btn-primary">
                        <i class='fas fa-edit' style='font-size:24px'></i>Edit</button></a>
