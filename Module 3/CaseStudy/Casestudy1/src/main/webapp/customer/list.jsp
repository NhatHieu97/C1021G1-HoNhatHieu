...
<body>
<a class="btn btn-success" href="/customers?action=create">Add new customer</a>
...
<table id="list" class="table table-striped">
    ...
    <c:forEach var="employee" items="${customerList}">
        <tr>
            ...
            <td >${employee.customerType}</td>
            <td>
                <button class="btn btn-warning">
                    <a href="/customers?action=update&id=${employee.getId()}">Edit</a>
                </button>
